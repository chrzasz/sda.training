...
import sda.training.linkedListHash.PatientRegistryUsingOwnHashMap;

import java.util.*;
import java.util.stream.Collectors;
import java.util.stream.IntStream;

import static sda.training.linkedListHash.Utils.nanoToMilliSeconds;
import static sda.training.linkedListHash.Utils.nanoToSeconds;
import static sda.training.linkedListHash.Utils.randomPesel;
...
//        PatientRegistry registry = new PatientRegistryUsingHashMap();
        PatientRegistry registry = new PatientRegistryUsingOwnHashMap();
